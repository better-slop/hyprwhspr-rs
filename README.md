...
- **See the [example docs](https://github.com/better-slop/hyprwhspr-rs/blob/main/docs/hyprland.md) for additional integration paths outside of Waybar and Walker/Elephant.**# 
